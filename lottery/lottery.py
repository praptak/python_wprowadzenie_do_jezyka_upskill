...
def create_list_with_weighed_participants(participants_data_list: List[Dict]):
    ...
    :return:
    """
    return [ParticipantWeighed.from_dict(record) for record in participants_data_list]
...
def create_trial_list(weighed_participants_list: List[ParticipantWeighed]):
    ...
    :return:
    """
    return [Participant(record.id, record.first_name, record.last_name) for record in weighed_participants_list for _ in
